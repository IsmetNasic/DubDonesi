...
def store(request):
	...
	if request.user.is_authenticated:
		...
		context = {'products':products, 'cartItems':cartItems, 'variation':variation}
...
def cart(request):
	if request.user.is_authenticated:
		...
		context = {'items':items, 'order':order, 'cartItems':cartItems, 'itemSize':itemSize}
...
def updateItem(request):
	...
	orderItem, created = OrderItem.objects.get_or_create(order=order, product=product, variation=variation)
